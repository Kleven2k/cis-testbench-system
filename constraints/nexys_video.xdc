...
## Clock Signal
set_property -dict { PACKAGE_PIN R4    IOSTANDARD LVCMOS33 } [get_ports { clk_100m }]; #IO_L13P_T2_MRCC_34 Sch=sysclk
...
set_property -dict { PACKAGE_PIN G4  IOSTANDARD LVCMOS33 } [get_ports { btn_rst_n }];
